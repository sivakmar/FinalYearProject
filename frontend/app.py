...
st.sidebar.markdown("<h2 style='color:blue;'>Sidebar</h2>", unsafe_allow_html=True)
...
if st.button("Send"):
    if option =="Text":
        backend_url = "http://127.0.0.1:5000/predict_sentiment"  # Update with your actual backend URL
        ...
        result=model.transcribe('C:/Users/siva/Downloads/vivian/backend/uploads/saved_audio.mp3')
        data=result['text']
        backend_url = "http://127.0.0.1:5000/predict_sentiment"  # Update with your actual backend URL
        ...
        img=Image.open('C:/Users/siva/Downloads/vivian/backend/uploads2/saved_image.png')
